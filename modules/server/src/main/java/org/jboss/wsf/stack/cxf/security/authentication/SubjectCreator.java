   ...
   public Subject createSubject(SecurityDomainContext ctx, String name, String password, boolean isDigest, String nonce, String created)
   {
      ...
      if (securityDomain != null) {
         ...
         try {
            ...
            ClearPassword clearPassword = credential != null? credential.getPassword(ClearPassword.class) : null;
            String expectedPassword = clearPassword != null? new String(clearPassword.getPassword()) : null;
            if (expectedPassword != null && isDigest && created != null && nonce != null) { // username token profile is using digest
